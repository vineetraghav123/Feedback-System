...
$pdf->Image('pics/slide1.jpg',0,0);
$pdf->Ln(52);
$pdf->Cell(0,10,"$teacher",1,1,"C",1);
$pdf->SetTextColor(255,255,255);
$pdf->SetFillColor(254,101,25);
...
$pdf->SetTextColor(255,255,255);
$pdf->SetFillColor(254,101,25);
$pdf->Cell(18,10,"Punctuality",1,0,"C",1);
$pdf->Cell(17,10,"Regularity",1,0,"C",1);
$pdf->Cell(28,10,"Completes syllabus",1,0,"C",1);
$pdf->Cell(49,10,"Conducting classroom discussions",1,0,"C",1);
$pdf->Cell(34,10,"Teaching subject matter",1,0,"C",1);
$pdf->Cell(44,10,"Student's participation in class",1,1,"C",1);
...
while($row=mysqli_fetch_assoc($result)){
	...
	$pdf->SetTextColor(250,0,0);
	$pdf->Cell(2,5,"$count",0,0,"C");
	$count++;
	$pdf->SetTextColor(66,139,202);
	//$pdf->Write(0,"($sem) :");
	$pdf->Cell(5,5,$sem,1,0,"C");
	$pdf->SetTextColor(0,0,0);
	$pdf->Cell(11,5,$row['subject1'],1,0,"C");
	$pdf->Cell(17,5,$row['subject2'],1,0,"C");
	$pdf->Cell(28,5,$row['subject3'],1,0,"C");
	$pdf->Cell(49,5,$row['subject4'],1,0,"C");
	$pdf->Cell(34,5,$row['subject5'],1,0,"C");
	$pdf->Cell(44,5,$row['subject6'],1,1,"C");
}
...
$pdf->SetTextColor(255,255,255);
	$pdf->SetFillColor(254,101,25);
$pdf->Cell(0,5,"Total Feedback Given: $t",1,1,"C",1);

$pdf->Cell(0,5,"Feedback Marks From: $fp [Total feedback given * max per Subject(like Punctuality)][Max=4,Min=0]",1,1,"C",1);
...
$pdf->SetTextColor(0,0,0);
$pdf->Cell(18,5,"$m1",1,0,"C");
$pdf->Cell(17,5,"$m2",1,0,"C");
$pdf->Cell(28,5,"$m3",1,0,"C");
$pdf->Cell(49,5,"$m4",1,0,"C");
$pdf->Cell(34,5,"$m5",1,0,"C");
$pdf->Cell(44,5,"$m6",1,1,"C");
$pdf->Ln(5);
...
if($first>0){
	...
	$pdf->SetTextColor(255,255,255);
	$pdf->SetFillColor(254,101,25);
	$pdf->Cell(0,5,"1st Semester",1,1,"C",1);
	$pdf->SetTextColor(0,0,0);
	$pdf->Cell(0,5,"Max : $maxx",1,1,"C");
	$pdf->Cell(0,5,"Obtained : $sum1",1,1,"C");
	$pdf->Ln(5);
}
if($third>0){
	$maxx=$third*24;
	$pdf->SetTextColor(255,255,255);
	$pdf->SetFillColor(254,101,25);
	$pdf->Cell(0,5,"3rd Semester",1,1,"C",1);
	$pdf->SetTextColor(0,0,0);
	$pdf->Cell(0,5,"Max : $maxx",1,1,"C");
	$pdf->Cell(0,5,"Obtained : $sum3",1,1,"C");
	$pdf->Ln(5);
}
if($fifth>0){
	$maxx=$fifth*24;
	$pdf->SetTextColor(255,255,255);
	$pdf->SetFillColor(254,101,25);
	$pdf->Cell(0,5,"5th Semester",1,1,"C",1);
	$pdf->SetTextColor(0,0,0);
	$pdf->Cell(0,5,"Max : $maxx",1,1,"C");
	
	$pdf->Cell(0,5,"Obtained : $sum5",1,1,"C");
	$pdf->Ln(5);
}
if($seventh>0){
	$maxx=$seventh*24;
	$pdf->SetTextColor(255,255,255);
	$pdf->SetFillColor(254,101,25);
	$pdf->Cell(0,5,"7th Semester",1,1,"C",1);
	$pdf->SetTextColor(0,0,0);
	$pdf->Cell(0,5,"Max : $maxx",1,1,"C");
	$pdf->Cell(0,5,"Obtained : $sum7",1,1,"C");
	$pdf->Ln(5);
}
...
$pdf->SetTextColor(255,255,255);
	$pdf->SetFillColor(254,101,25);
$pdf->Cell(0,5,"Total",1,1,"C",1);
$pdf->SetTextColor(255,255,255);
$pdf->SetFillColor(76,175,80);
$pdf->Cell(0,5,"Max : $fp",1,1,"C",1);
$pdf->Cell(0,5,"Obtained : $obtained",1,1,"C",1);
$pdf->SetTextColor(255,255,255);
$pdf->Cell(0,5,"$fav Student(s) selected you as their favorite teacher.",1,1,"C",1);
